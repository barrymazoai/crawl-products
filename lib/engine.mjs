...
function normalizeProductUrl(url) {
	...
	parsed.hash = "";
	for (const key of [...parsed.searchParams.keys()]) if (/^(?:variant|categorycode|utm_|fbclid|gclid|selected_size|currency|lang)/i.test(key)) parsed.searchParams.delete(key);
